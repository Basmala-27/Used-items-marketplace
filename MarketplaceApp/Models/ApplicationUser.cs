...
namespace MarketplaceApp.Models
{
    public class ApplicationUser : IdentityUser
    {
        ...
        public virtual ICollection<Complaint> ComplaintsSubmitted { get; set; } = new List<Complaint>();

        public virtual ICollection<Complaint> ComplaintsReceived { get; set; } = new List<Complaint>();
    }
}